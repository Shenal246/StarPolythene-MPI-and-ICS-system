...
export class UserService {
  ...
  async getEmployee(query:string): Promise<Employee| undefined> {
    const employee = await this.http.get<Employee>('http://localhost:8080/users/employee?username='+query).toPromise();
